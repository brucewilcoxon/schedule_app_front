...
export type GasProcess = 'recovery' | 'filling' | 'refilling' | 'recovery_refilling' | 'recovery_disposal' | 'recovery_impossible';
...
export interface GasSummary {
  ...
  recovery_refilling: number; // 回収/再充填
  recovery_disposal: number; // 回収/廃棄
  recovery_impossible: number; // 回収不可
  total: number; // 合計
}
