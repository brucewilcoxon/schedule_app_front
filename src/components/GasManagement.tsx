...
const GasManagement: React.FC = () => {
  ...
  const processOptions: GasProcessOption[] = [
    ...
    { value: 'recovery_refilling', label: '回収/再充填' },
    { value: 'recovery_disposal', label: '回収/廃棄' },
    { value: 'recovery_impossible', label: '回収不可' },
  ];
  ...
  const handleDeleteGas = async (id: number) => {
    if (window.confirm('このガス記録を削除してもよろしいですか？')) {
      try {
        ...
        <Layout>
          <div className="flex items-center justify-center h-64">
            <div className="text-center">
              ...
              <p className="mt-4 text-gray-600">データを読み込み中です...</p>
            </div>
          </div>
        </Layout>
      </RequireAuth>
    ...
    return (
      <RequireAuth>
        <Layout>
          <div className="flex items-center justify-center h-64">
            <div className="text-center">
              <div className="text-red-600 text-xl mb-4">エラーが発生いたしました</div>
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200">    
            <div className="px-4 py-3 border-b border-gray-200">
              <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3">
                <h2 className="text-lg font-semibold text-gray-900">ガスデータ一覧表</h2>
