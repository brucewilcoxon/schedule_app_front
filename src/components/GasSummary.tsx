  ...
  return (
    <div className="mb-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-3">
        ...
        {/* 回収/再充填 (Recovery/Refilling) */}
        <div className="bg-gray-100 rounded-lg p-3 text-center">
          <div className="text-xs text-gray-600 mb-1">回収/再充填</div>
          <div className="text-lg font-bold text-gray-900">
            {formatNumber(summary.recovery_refilling)} kg
          </div>
        </div>

        {/* 回収/廃棄 (Recovery/Disposal) */}
        <div className="bg-gray-100 rounded-lg p-3 text-center">
          <div className="text-xs text-gray-600 mb-1">回収/廃棄</div>
          <div className="text-lg font-bold text-gray-900">
            {formatNumber(summary.recovery_disposal)} kg
          </div>
        </div>

        {/* 回収不可 (Recovery Impossible) */}
        <div className="bg-gray-100 rounded-lg p-3 text-center">
          <div className="text-xs text-gray-600 mb-1">回収不可</div>
          <div className="text-lg font-bold text-gray-900">
            {formatNumber(summary.recovery_impossible)} kg
          </div>
        </div>
      </div>
    </div>
